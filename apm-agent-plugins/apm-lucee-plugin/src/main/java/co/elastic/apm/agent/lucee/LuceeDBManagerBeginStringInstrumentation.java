...
public class LuceeDBManagerBeginStringInstrumentation extends TracerAwareInstrumentation {
    ...
    public static class CfDBMBeginStringAdvice {
        ...
        public static Object onBeforeExecute(@Advice.Argument(value=0) @Nullable String transactionIsolationLvl) {

            if (tracer == null || tracer.getActive() == null || transactionIsolationLvl == null) {
                return null;
            }
